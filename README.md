# Phd(pizza hut delivery) Cli V3

Tool Phd(pizza hut delivery) cli v3 dari eastlombok team,di buat oleh sayidina ahmadal qososyi,tool yang di gunakan untuk auto cek akun Phd(pizza hut delivery) target dengan emailnya.
...
```bash
git clone https://github.com/oendnsk675/phd-cli-v1.0.git
```
